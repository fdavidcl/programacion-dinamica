...
\renewcommand{\abstractname}{Índice} % Uncomment to change the name of the abstract to something else
...
\section{Terminales de venta}
  \subsection{Enunciado}
    Dado un conjunto de monedas $\{m_1, m_2, \dots, m_n\} \subset \mathbb{N}$, buscamos frecuencias $\{f_1,f_2,\dots f_n\} \subset \mathbb{N}$ de 
