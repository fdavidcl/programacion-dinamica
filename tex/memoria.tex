...
\section{Caminos mínimos en grafos}
  ...
  \subsection{Algoritmo de Johnson}
	...
	\subsubsection{Requisitos y eficiencia}
      Para poder ejecutar el algoritmo de Johnson, dado que utiliza el algoritmo de Bellman-Ford tenemos los mismos requisitos, es decir, debemos requerir que el grafo no contenga ciclos de peso negativo.
\end{document}